...
public class MainSum {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < sumArr.length; i++) {
            ...
            System.out.printf("Total Keuntungan Perusahaan Selama %d Bulan Adalah : %.2f juta\n", sumArr[i].bulan, sumArr[i].totalBF(sumArr[i].keuntungan));
            System.out.println();
            System.out.println("==Algoritma Divide Conquer==");
            System.out.println("Total Keuntungan Perusahaan Selama " + sumArr[i].bulan + " Bulan Adalah : " + sumArr[i].totalDC(sumArr[i].keuntungan, 0, sumArr[i].bulan - 1) + " Juta");
            System.out.println("----------------------------");
        }
    }
}